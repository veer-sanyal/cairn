...
- **Instance domain** (e.g. study coach, PM tracker):
- **Instance age** (days since scaffold):
- **Sessions logged:**
- **Lapses by type** (forgot / upkeep / skipped / suspended):
- **North-star trend** (in your own words — up / flat / down, and roughly by how much):
- **Concluded or suspended?** (and why, if you'd like to say):
- **Anything that felt like upkeep burden** (these are treated as kernel bugs — tell us):
- **Anything else:**
