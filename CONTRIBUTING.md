...
Want to share how an instance is going? Keel collects nothing automatically (telemetry is local
...
propose them as issues; `/keel:upgrade` migrates instances with a changelog diff.
